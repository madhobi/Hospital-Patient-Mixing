...
output_file('../output_file/dason_mixing_matrices_pie_chart.html')
...
def main():
    ...
    data_no_antibiotic_ratio = pd.read_csv('../data/antibiotic_exposed_vs_no_antibiotic_proportion.csv', delimiter=',')
    print(data_no_antibiotic_ratio.head(5))
    print(data_no_antibiotic_ratio.columns)
